...
const ResetPasswordEmail = (
    ...
    const TextBody = `Your reset password link for Seattle LMS`;
    const Subject = `Your reset password link for Seattle LMS`;
...
<style>
		* {
		...
		@media (max-width:620px) {
			...
			.row-11 .column-1 .block-1.divider_block td.pad {
				padding: 0 !important;
			}

			.row-11 .column-1 .block-1.divider_block .alignment table {
...
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f1f5f9; background-image: none; background-position: top left; background-size: auto; background-repeat: no-repeat;" width="100%">
<tbody>
<tr>
<td>
...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 35px; padding-right: 38px; padding-top: 10px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="0" cellspacing="0" class="heading_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad" style="text-align:center;width:100%;">
<h1 style="margin: 0; color: #15283a; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; letter-spacing: normal; line-height: 180%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 43.2px;"><span class="tinyMce-placeholder">Forgot your password?</span></h1>
</td>
</tr>
</table>
</td>
...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 38px; padding-right: 38px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 38px; padding-right: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://google.com" style="height:42px;width:213px;v-text-anchor:middle;" arcsize="24%" stroke="false" fillcolor="#32936c">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
<![endif]--><a href="https://google.com" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#32936c;border-radius:10px;width:auto;border-top:0px solid transparent;font-weight:700;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:32px;padding-right:32px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">RESET PASSWORD</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
</td>
</tr>
</table>
</td>
...
<td class="pad">
<div style="color:#1d252e;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:180%;text-align:left;mso-line-height-alt:28.8px;">
<p style="margin: 0; margin-bottom: 24px;">Or, paste this link into your browser: <a href="https://www.magicalkenyatravelsp ecialist.com/user/reset-password?token=${data.token}" rel="noopener" style="text-decoration: none; color: #32936c;" target="_blank">https://www.magicalkenyatravelsp ecialist.com/user/reset-password?token=${data.token}</a></p>
<p style="margin: 0; margin-bottom: 24px;">This code is only active for the next 90 minutes. Once the code expires you will have to resubmit a request for a code.</p>
<p style="margin: 0;">Regards,<br/>i-prefer</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="divider_inner" style="font-size: 1px; line-height: 1px; border-top: 1px solid #C8CBCF;"><span> </span></td>
</tr>
</table>
</div>
</td>
